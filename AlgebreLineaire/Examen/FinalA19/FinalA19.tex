...
\begin{document}
		...
		{\large \today\par}
	\end{titlepage}
\input{Question/Q1}\setcounter{subsection}{0}
\input{Question/Q2}\setcounter{subsection}{0}
\input{Question/Q3}\setcounter{subsection}{0}
\input{Question/Q4}\setcounter{subsection}{0}
\end{document}
